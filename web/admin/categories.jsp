<%-- 
    Document   : categories
    Created on : Nov 10, 2024, 2:35:37 PM
    Author     : VIET
--%>
    ...
    <body class="py-10">
        ...
        <div class="bg-white shadow border rounded-lg p-6 max-w-screen-xl mx-auto mt-10">
            ...
            <div class="flex items-center justify-between py-2">
                ...
                <a href="/TangKinhCac/admin/categories/create.jsp" class="block p-2 bg-black text-white rounded-md">Create new Category</a>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 h-2/3 overflow-y-scroll">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <c:forEach items="${list}" var="c">
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">${list.indexOf(c) + 1}</td>

                                <td class="px-6 py-4 whitespace-nowrap">${c.categoryName}</td>
                                <td>
                                    <a href="/TangKinhCac/admin/categoryEdit/${a.categoryID}">Edit</a>
                                </td>
                                <td>
                                    <form action="/TangKinhCac/admin/categoryView" method="POST">
                                        <input name="categoryID" value="${c.categoryID}" hidden="true" />
                                        <button type="submit">View</button>
                                    </form>
                                </td>
                                <td>
                                    <form action="/TangKinhCac/admin/categoryDelete" method="POST">
                                        <input name="categoryID" value="${c.categoryID}" hidden="true" />
